...
// const APImods = require('./stats.json')
// const APIitems = require('./items.json')
// import { ipcRenderer } from 'electron'
import Store from 'electron-store'
import _ from 'lodash'
let APIitems,APImods
...
export function itemAnalyze(item){
    ...
    itemParsed=_.cloneDeep(itemParsedSample)
